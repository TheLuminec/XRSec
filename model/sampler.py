...
class Sampler:
    ...
    def _preprocess(self):
        ...
        Applies any configured data augmentation (scalar randomness).
        """
        ...
        for i in range(self.sample_count):
            ...
            if self.scalar_randomness > 0:
                self.samples[i] *= random.uniform(-1 - self.scalar_randomness, 1 + self.scalar_randomness)
