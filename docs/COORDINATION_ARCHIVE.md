# COORDINATION archive (resolved items)

Sections retired from `docs/COORDINATION.md` on 2026-09-10. **Nothing here is deleted, only
moved.** An entry was treated as resolved when its conclusion had already been promoted into
`CLAUDE.md` - the channel is transport, `CLAUDE.md` is the destination, and a channel that
keeps its transported items forever stops being readable as a channel.

Covers 2026-09-04 to 2026-09-08 plus resolved standing items. Active coordination, the queues,
the shared-tree rules and everything from 2026-09-09 stayed in `COORDINATION.md`.
